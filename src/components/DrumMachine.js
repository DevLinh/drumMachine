    ...
    this.state = {
      ...
      kit: [
        ...
        },
        {
          ...
          active: false,
          src:
            "https://cdn.glitch.com/0966cc53-0935-45e4-9edf-7c4fa500e219%2FRX15%20COWBELL.wav?1532352724065",
          name: "COWBELL"
        },
        {
          key: "C",
  ...
  render() {
    return (
      <div id="drum-machine" className="drum-machine-body">
        <div className="drum-machine-body__top">
          BeatBOX <span style={{ float: "right" }}>XZ219</span>
        </div>
        <div className="drum-machine-body__bottom">
          ...
          <div
            className={
              "drum-pad-container" +
              (this.state.power ? " drum-pad-container--on" : "")
            }
          >
